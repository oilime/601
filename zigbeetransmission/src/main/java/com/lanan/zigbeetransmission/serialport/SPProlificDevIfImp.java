...
public class SPProlificDevIfImp implements IDeviceIf {
    ...
    private void setParameters(int baudRate, int dataBits, String stopBits, String parity) {
        ...
        switch (stopBits) {
            case SP_OPTION_SBONE:
                lineRequestData[4] = 0;
                break;
            case SP_OPTION_SBONEPOINTFIVE:
                lineRequestData[4] = 1;
                break;
            case SP_OPTION_SBTWO:
                lineRequestData[4] = 2;
                break;
            default:
        ...
        switch (parity) {
            ...
            case SP_OPTION_PODD:
                lineRequestData[5] = 1;
                break;
            case SP_OPTION_PEVEN:
                lineRequestData[5] = 2;
                break;
            case SP_OPTION_PMARK:
                lineRequestData[5] = 3;
                break;
            case SP_OPTION_PSPACE:
                lineRequestData[5] = 4;
                break;
            default:
        ...
        if (ret != lineRequestData.length) {
            throw new RuntimeException("fail to set up parameter");
        }
    }
    ...
    private void setRtsAndDtr(boolean rts, boolean dtr) {
        ...
        if (ret != 0) {
            throw new RuntimeException("fail to set up dtr and rts");
        }
    }
